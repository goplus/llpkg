...
func StringRef(string *int8) *JSON
...
func FloatArray(numbers *float32, count c.Int) *JSON

//go:linkname DoubleArray C.cJSON_CreateDoubleArray
func DoubleArray(numbers *float64, count c.Int) *JSON

//go:linkname StringArray C.cJSON_CreateStringArray
func StringArray(strings **int8, count c.Int) *JSON
