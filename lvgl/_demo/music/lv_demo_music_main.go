...
import (
	...
	"github.com/goplus/llpkg/lvgl/ticker"
	"github.com/goplus/llpkg/lvgl/layouts"
)
...
const (
	...
	INTRO_TIME       = 2000
	BAR_CNT          = 20
	DEG_STEP         = (180 / BAR_CNT)
	BAND_CNT         = 4
	BAR_PER_BAND_CNT = (BAR_CNT / BAND_CNT)
)

// Colors
var (
	BAR_COLOR1 = core.ColorHex(0xe9dbfc)
	BAR_COLOR2 = core.ColorHex(0x6f8af6)
	BAR_COLOR3 = core.ColorHex(0xffffff)
)

// Bar dimensions
var (
	BAR_COLOR1_STOP int32
	BAR_COLOR2_STOP int32
	BAR_REST_RADIUS int32
	BAR_COLOR3_STOP int32
)

func init() {
	if core.DEMO_MUSIC_LARGE {
		BAR_COLOR1_STOP = 160
		BAR_COLOR2_STOP = 200
		BAR_REST_RADIUS = 165
	} else {
	...
	BAR_COLOR3_STOP = core.Max(display.LV_HOR_RES, display.LV_VER_RES) / 3
}
 ...
 * warning.
 */
func _image_set_scale_anim_cb(obj *core.LvObjT, scale int32) {
	widgets.LvImageSetScale((obj, (uint16_t)scale)
}
  ...
  * warning.
  */
 func _obj_set_x_anim_cb(obj *core.LvObjT, x int32) {
	 core.LvObjSetX(obj, (int32_t)x);
 }
 
 func lv_demo_music_main_create(parent *core.LvObjT) *core.LvObjT {
...
//  #endif
	 ...
	 static const int32_t grid_cols[] = {layout.LV_GRID_FR(1), layout.LV_GRID_FR(1), layout.LV_GRID_TEMPLATE_LAST};
	 static const int32_t grid_rows[] = {LV_DEMO_MUSIC_HANDLE_SIZE,     /*Spacing*/
										 layout.LV_GRID_FR(1),   /*Spacer*/
										 core.LV_GRID_CONTENT, /*Title box*/
										 layout.LV_GRID_FR(1),   /*Spacer*/
										 layout.LV_GRID_CONTENT, /*Icon box*/
										 layout.LV_GRID_FR(3),   /*Spacer*/
										 layout.LV_GRID_CONTENT, /*Control box*/
										 layout.LV_GRID_FR(1),   /*Spacer*/
										 layout.LV_GRID_CONTENT, /*Handle box*/
										 layout.LV_GRID_FR(1),   /*Spacer*/
										 LV_DEMO_MUSIC_HANDLE_SIZE,     /*Spacing*/
										 layout.LV_GRID_TEMPLATE_LAST
										};
 
	 layout.LvObjSetGridDscArray(cont, grid_cols, grid_rows);
	 layout.LvObjSetStyleGridRowAlign(cont, layout.LV_GRID_ALIGN_SPACE_BETWEEN, 0);
	 layout.LvObjSetGridCell(title_box, layout.LV_GRID_ALIGN_STRETCH, 0, 1, layout.LV_GRID_ALIGN_CENTER, 2, 1);
	 layout.LvObjSetGridCell(icon_box, layout.LV_GRID_ALIGN_STRETCH, 0, 1, layout.LV_GRID_ALIGN_CENTER, 4, 1);
	 layout.LvObjSetGridCell(ctrl_box, layout.LV_GRID_ALIGN_STRETCH, 0, 1, layout.LV_GRID_ALIGN_CENTER, 6, 1);
	 layout.LvObjSetGridCell(handle_box, layout.LV_GRID_ALIGN_STRETCH, 0, 2, layout.LV_GRID_ALIGN_CENTER, 8, 1);
	 layout.LvObjSetGridCell(spectrum_obj, layout.LV_GRID_ALIGN_STRETCH, 1, 1, layout.LV_GRID_ALIGN_CENTER, 1, 9);

	 sec_counter_timer := core.LvTimerCreate(timer_cb, 1000, nil);
	 core.LvTimerPause(sec_counter_timer);
