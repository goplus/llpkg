 ...
 */
// llgo:link (*PortMUXTYPE).VPortEnterCritical C.vPortEnterCritical
func (recv_ *PortMUXTYPE) VPortEnterCritical() {
}
...
// ------------------ Critical Sections --------------------
//
//go:linkname UxPortEnterCriticalFromISR C.uxPortEnterCriticalFromISR
func UxPortEnterCriticalFromISR() UBaseTypeT

// llgo:link UBaseTypeT.VPortExitCriticalFromISR C.vPortExitCriticalFromISR
func (recv_ UBaseTypeT) VPortExitCriticalFromISR() {
}

// llgo:link (*PortMUXTYPE).VPortTakeLock C.vPortTakeLock
func (recv_ *PortMUXTYPE) VPortTakeLock() {
}

// llgo:link (*PortMUXTYPE).VPortReleaseLock C.vPortReleaseLock
func (recv_ *PortMUXTYPE) VPortReleaseLock() {
}

// Critical sections used by FreeRTOS SMP
//
//go:linkname VTaskEnterCritical C.vTaskEnterCritical
func VTaskEnterCritical()

//go:linkname VTaskExitCritical C.vTaskExitCritical
func VTaskExitCritical()

//go:linkname VTaskEnterCriticalFromISR C.vTaskEnterCriticalFromISR
func VTaskEnterCriticalFromISR() UBaseTypeT

// llgo:link UBaseTypeT.VTaskExitCriticalFromISR C.vTaskExitCriticalFromISR
func (recv_ UBaseTypeT) VTaskExitCriticalFromISR() {
}

// llgo:link (*PortMUXTYPE).VPortExitCriticalIDF C.vPortExitCriticalIDF
func (recv_ *PortMUXTYPE) VPortExitCriticalIDF() {
}
 ...
 */
//go:linkname UlPortSetInterruptMask C.ulPortSetInterruptMask
func UlPortSetInterruptMask() UBaseTypeT
 ...
 */
// llgo:link UBaseTypeT.VPortClearInterruptMask C.vPortClearInterruptMask
func (recv_ UBaseTypeT) VPortClearInterruptMask() {
}
