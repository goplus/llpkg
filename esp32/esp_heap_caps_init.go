 ...
 * at other times.
 */
//go:linkname HeapCapsInit C.heap_caps_init
func HeapCapsInit()
 ...
 * be enabled.
 */
//go:linkname HeapCapsEnableNonosStackHeaps C.heap_caps_enable_nonos_stack_heaps
func HeapCapsEnableNonosStackHeaps()
...
*/
//go:linkname HeapCapsAddRegion C.heap_caps_add_region
func HeapCapsAddRegion(start c.IntptrT, end c.IntptrT) EspErrT
...
*/
//go:linkname HeapCapsAddRegionWithCaps C.heap_caps_add_region_with_caps
func HeapCapsAddRegionWithCaps(caps *c.Uint32T, start c.IntptrT, end c.IntptrT) EspErrT
