...
type InterruptCore1DevS struct {
	Reserved0       c.Uint32T
	Reserved4       c.Uint32T
	Reserved8       c.Uint32T
	ReservedC       c.Uint32T
	...
	Core1MacIntrMap struct {
		Val c.Uint32T
	}
	Core1MacNmiMap struct {
		Val c.Uint32T
	}
	Core1PwrIntrMap struct {
		Val c.Uint32T
	}
	Core1BbIntMap struct {
		Val c.Uint32T
	}
	Core1BtMacIntMap struct {
		Val c.Uint32T
	}
	Core1BtBbIntMap struct {
		Val c.Uint32T
	}
	Core1BtBbNmiMap struct {
		Val c.Uint32T
	}
	Core1RwbtIrqMap struct {
		Val c.Uint32T
	}
	Core1RwbleIrqMap struct {
		Val c.Uint32T
	}
	Core1RwbtNmiMap struct {
		Val c.Uint32T
	}
	Core1RwbleNmiMap struct {
		Val c.Uint32T
	}
	Core1I2cMstIntMap struct {
		Val c.Uint32T
	}
	Core1Slc0IntrMap struct {
		Val c.Uint32T
	}
	Core1Slc1IntrMap struct {
		Val c.Uint32T
	}
	Core1Uhci0IntrMap struct {
		Val c.Uint32T
	}
	Core1Uhci1IntrMap struct {
		Val c.Uint32T
	}
	Core1GpioInterruptProMap struct {
		Val c.Uint32T
	}
	Core1GpioInterruptProNmiMap struct {
		Val c.Uint32T
	}
	Core1GpioInterruptAppMap struct {
		Val c.Uint32T
	}
	Core1GpioInterruptAppNmiMap struct {
		Val c.Uint32T
	}
	Core1SpiIntr1Map struct {
		Val c.Uint32T
	}
	Core1SpiIntr2Map struct {
		Val c.Uint32T
	}
	Core1SpiIntr3Map struct {
		Val c.Uint32T
	}
	Core1SpiIntr4Map struct {
		Val c.Uint32T
	}
	Core1LcdCamIntMap struct {
		Val c.Uint32T
	}
	Core1I2s0IntMap struct {
		Val c.Uint32T
	}
	Core1I2s1IntMap struct {
		Val c.Uint32T
	}
	Core1UartIntrMap struct {
		Val c.Uint32T
	}
	Core1Uart1IntrMap struct {
		Val c.Uint32T
	}
	Core1Uart2IntrMap struct {
		Val c.Uint32T
	}
	Core1SdioHostInterruptMap struct {
		Val c.Uint32T
	}
	Core1Pwm0IntrMap struct {
		Val c.Uint32T
	}
	Core1Pwm1IntrMap struct {
		Val c.Uint32T
	}
	Core1Pwm2IntrMap struct {
		Val c.Uint32T
	}
	Core1Pwm3IntrMap struct {
		Val c.Uint32T
	}
	Core1LedcIntMap struct {
		Val c.Uint32T
	}
	Core1EfuseIntMap struct {
		Val c.Uint32T
	}
	Core1CanIntMap struct {
		Val c.Uint32T
	}
	Core1UsbIntrMap struct {
		Val c.Uint32T
	}
	Core1RtcCoreIntrMap struct {
		Val c.Uint32T
	}
	Core1RmtIntrMap struct {
		Val c.Uint32T
	}
	Core1PcntIntrMap struct {
		Val c.Uint32T
	}
	Core1I2cExt0IntrMap struct {
		Val c.Uint32T
	}
	Core1I2cExt1IntrMap struct {
		Val c.Uint32T
	}
	Core1Spi2DmaIntMap struct {
		Val c.Uint32T
	}
	Core1Spi3DmaIntMap struct {
		Val c.Uint32T
	}
	Core1Spi4DmaIntMap struct {
		Val c.Uint32T
	}
	Core1WdgIntMap struct {
		Val c.Uint32T
	}
	Core1TimerInt1Map struct {
		Val c.Uint32T
	}
	Core1TimerInt2Map struct {
		Val c.Uint32T
	}
	Core1TgT0IntMap struct {
		Val c.Uint32T
	}
	Core1TgT1IntMap struct {
		Val c.Uint32T
	}
	Core1TgWdtIntMap struct {
		Val c.Uint32T
	}
	Core1Tg1T0IntMap struct {
		Val c.Uint32T
	}
	Core1Tg1T1IntMap struct {
		Val c.Uint32T
	}
	Core1Tg1WdtIntMap struct {
		Val c.Uint32T
	}
	Core1CacheIaIntMap struct {
		Val c.Uint32T
	}
	Core1SystimerTarget0IntMap struct {
		Val c.Uint32T
	}
	Core1SystimerTarget1IntMap struct {
		Val c.Uint32T
	}
	Core1SystimerTarget2IntMap struct {
		Val c.Uint32T
	}
	Core1SpiMemRejectIntrMap struct {
		Val c.Uint32T
	}
	Core1DcachePreloadIntMap struct {
		Val c.Uint32T
	}
	Core1IcachePreloadIntMap struct {
		Val c.Uint32T
	}
	Core1DcacheSyncIntMap struct {
		Val c.Uint32T
	}
	Core1IcacheSyncIntMap struct {
		Val c.Uint32T
	}
	Core1ApbAdcIntMap struct {
		Val c.Uint32T
	}
	Core1DmaInCh0IntMap struct {
		Val c.Uint32T
	}
	Core1DmaInCh1IntMap struct {
		Val c.Uint32T
	}
	Core1DmaInCh2IntMap struct {
		Val c.Uint32T
	}
	Core1DmaInCh3IntMap struct {
		Val c.Uint32T
	}
	Core1DmaInCh4IntMap struct {
		Val c.Uint32T
	}
	Core1DmaOutCh0IntMap struct {
		Val c.Uint32T
	}
	Core1DmaOutCh1IntMap struct {
		Val c.Uint32T
	}
	Core1DmaOutCh2IntMap struct {
		Val c.Uint32T
	}
	Core1DmaOutCh3IntMap struct {
		Val c.Uint32T
	}
	Core1DmaOutCh4IntMap struct {
		Val c.Uint32T
	}
	Core1RsaIntMap struct {
		Val c.Uint32T
	}
	Core1AesIntMap struct {
		Val c.Uint32T
	}
	Core1ShaIntMap struct {
		Val c.Uint32T
	}
	Core1CpuIntrFromCpu0Map struct {
		Val c.Uint32T
	}
	Core1CpuIntrFromCpu1Map struct {
		Val c.Uint32T
	}
	Core1CpuIntrFromCpu2Map struct {
		Val c.Uint32T
	}
	Core1CpuIntrFromCpu3Map struct {
		Val c.Uint32T
	}
	Core1AssistDebugIntrMap struct {
		Val c.Uint32T
	}
	Core1DmaApbperiPmsMonitorViolateIntrMap struct {
		Val c.Uint32T
	}
	Core1Core0Iram0PmsMonitorViolateIntrMap struct {
		Val c.Uint32T
	}
	Core1Core0Dram0PmsMonitorViolateIntrMap struct {
		Val c.Uint32T
	}
	Core1Core0PifPmsMonitorViolateIntrMap struct {
		Val c.Uint32T
	}
	Core1Core0PifPmsMonitorViolateSizeIntrMap struct {
		Val c.Uint32T
	}
	Core1Core1Iram0PmsMonitorViolateIntrMap struct {
		Val c.Uint32T
	}
	Core1Core1Dram0PmsMonitorViolateIntrMap struct {
		Val c.Uint32T
	}
	Core1Core1PifPmsMonitorViolateIntrMap struct {
		Val c.Uint32T
	}
	Core1Core1PifPmsMonitorViolateSizeIntrMap struct {
		Val c.Uint32T
	}
	Core1BackupPmsViolateIntrMap struct {
		Val c.Uint32T
	}
	Core1CacheCore0AcsIntMap struct {
		Val c.Uint32T
	}
	Core1CacheCore1AcsIntMap struct {
		Val c.Uint32T
	}
	Core1UsbDeviceIntMap struct {
		Val c.Uint32T
	}
	Core1PeriBackupIntMap struct {
		Val c.Uint32T
	}
	Core1DmaExtmemRejectIntMap struct {
		Val c.Uint32T
	}
	Core1IntrStatus0 c.Uint32T
	Core1IntrStatus1 c.Uint32T
	Core1IntrStatus2 c.Uint32T
	Core1IntrStatus3 c.Uint32T
	Core1ClockGate   struct {
		Val c.Uint32T
	}
	...
	Core1InterruptDate struct {
		Val c.Uint32T
	}
}
type InterruptCore1DevT InterruptCore1DevS
